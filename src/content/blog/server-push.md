...
description: 'Socket.IO와 Server-Sent Events(SSE)의 특징, 구현 방법 및 사용 사례 비교'
...
![socketio-demo](/blog-images/socketio-example.gif)
...
![sse-example](/blog-images/sse-example.gif)
