...
description: 'Electron에서 alert 후 input 포커스가 잡히지 않는 문제를 executeJavaScript로 해결하기'
...
| :--------------------------------------: | :--------------------------------------: |
| ![](/blog-images/electron-alert-input-1.png) | ![](/blog-images/electron-alert-input-2.png) |
